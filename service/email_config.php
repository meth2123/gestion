<?php
/**
 * Configuration d'email centralisée - Brevo (Sendinblue) uniquement
 ...
 * 
 * IMPORTANT : Brevo est maintenant le seul service d'email supporté
 */
...
/**
 * Envoie un email en utilisant UNIQUEMENT Brevo (Sendinblue)
 * 

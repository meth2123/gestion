...
$user_type = 'parent'; // Forcer le type à parent pour la compatibilité
$notificationService = new NotificationService($link, $check, $user_type);
$unread_count = $notificationService->countUnread();
?>
<!DOCTYPE html>
<html lang="fr">
<head>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="notifications.php" class="relative text-gray-600 hover:text-blue-500">
    ...
    <div class="bg-white shadow-md mt-6 mx-4 lg:mx-auto max-w-7xl rounded-lg">
        <div class="flex flex-wrap justify-center gap-4 p-4">
            ...
            <a href="notifications.php" class="bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">
                ...
                <?php if ($unread_count > 0): ?>
                <span class="ml-1 bg-red-500 text-white text-xs rounded-full px-2 py-1"><?php echo $unread_count > 9 ? '9+' : $unread_count; ?></span>
                <?php endif; ?>
            </a>
        </div>
    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($_SESSION['parent_id']); ?></td>

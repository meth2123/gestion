                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="px-3 py-1 text-sm font-medium rounded-full 
                                    <?php echo (strtoupper($child['sex']) === 'M' || strtoupper($child['sex']) === 'MALE' || strtoupper($child['sex']) === 'MASCULIN' || strtoupper($child['sex']) === 'H' || strtoupper($child['sex']) === 'HOMME' || $child['sex'] === '1') ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800'; ?>">

                    ...
                    <div class="bg-blue-50 p-6 rounded-lg">
                        <div class="text-center">
                            ...
                            <p class="text-3xl font-bold text-blue-600">
                                <?php echo number_format($monthly_salary, 2, ',', ' '); ?> FCFA
                            </p>
                            <p class="text-sm text-blue-500 mt-2">Basé sur un salaire annuel de <?php echo number_format($stinfo['salary'], 2, ',', ' '); ?> FCFA</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-green-50 p-6 rounded-lg">
                        <div class="text-center">
                            ...
                            <p class="text-3xl font-bold text-green-600">
                                <?php echo number_format($payable_salary, 2, ',', ' '); ?> FCFA
                            </p>
                ...
                <div class="mt-8 bg-gray-50 p-6 rounded-lg">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-medium"><?php echo number_format($daily_rate, 2, ',', ' '); ?> FCFA</span>
                        </div>
                        <div class="flex justify-between items-center">

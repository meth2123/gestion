            ...
            <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 gap-4">
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <p class="font-medium"><?php echo htmlspecialchars($_SESSION['staff_id']); ?></p>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="font-medium"><?php echo htmlspecialchars(number_format(round($stinfo['salary']/12, 2), 2, ',', ' ')); ?> FCFA</p>
                    </div>
                </div>
            </div>
        </div>

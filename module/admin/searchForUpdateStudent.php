...
try {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<tr class="hover:bg-gray-50">
            <form id="form_'.$row['id'].'" action="updateStudentProcess.php" method="post" class="w-full" enctype="multipart/form-data">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <input type="date" name="addmissiondate" value="'.htmlspecialchars($row['addmissiondate']).'"  
                           class="border rounded px-2 py-1 w-full">
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <input type="text" name="parentid" value="'.htmlspecialchars($row['parentid']).'"  
                           class="border rounded px-2 py-1 w-full">
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <input type="text" name="classid" value="'.htmlspecialchars($row['classid']).'"  
                           class="border rounded px-2 py-1 w-full">
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <a href="directUpdateForm.php?id='.htmlspecialchars($row['id']).'" 

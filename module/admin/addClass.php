...
$admin_name = $login_session; // Utilisation de la variable définie dans main.php
...
if(isset($_POST['submit'])){
    try {
        ...
        try {
            ...
            // Logger l'erreur mais ne pas bloquer la création de la classe
...
$content .= '<div class="alert alert-info d-flex justify-content-between align-items-center">';
$content .= '<div>';
$content .= '<i class="fas fa-file-excel me-2"></i>';
$content .= '<strong>Importation en masse</strong> - Téléversez un fichier Excel pour ajouter plusieurs classes à la fois';
$content .= '</div>';
$content .= '<a href="importClasses.php" class="btn btn-success">';
$content .= '<i class="fas fa-upload me-2"></i>Importer depuis Excel';
$content .= '</a>';
$content .= '</div>';
$content .= '</div>';
$content .= '</div>';

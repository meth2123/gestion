    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="fas fa-file-excel text-success me-2"></i>Importation d'Assignations depuis Excel</h3>
                <a href="assignStudents.php" class="btn btn-secondary">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <ol class="mb-3">
                        ...
                        <li>Remplissez les assignations (ID Étudiant, ID Enseignant, ID Cours, ID Classe)</li>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0">
                            <li>Tous les ID doivent exister dans le système</li>
                            <li>Un étudiant peut avoir plusieurs assignations</li>
                        </ul>
                    </div>

                    <a href="downloadAssignmentTemplate.php" class="btn btn-success">
                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data" id="importForm">
                        ...
                        <button type="submit" name="import" class="btn btn-primary">
                            <i class="fas fa-file-import me-2"></i>Importer les assignations
                        </button>
                    </form>
                </div>
            </div>
    ...
    try {
        ...
        foreach ($rows as $index => $row) {
            ...
            try {
                ...
                if (empty($studentId) || empty($teacherId) || empty($courseId) || empty($classId)) {
                ...
                if (!$existing) {
                    ...
                    db_query(
                        ...
                        VALUES (?, ?, ?, ?, ?, NOW())",
                        [$studentId, $teacherId, $courseId, $classId, $admin_id],
                        'sssss'
                    );
                    $successCount++;
                } else {
                    throw new Exception("Assignation déjà existante");
                }

            } catch (Exception $e) {
                $errorCount++;
                $errors[] = "Ligne $lineNumber ($studentId): " . $e->getMessage();
        ...
        if ($successCount > 0) {
            ...
            echo "<p><strong>$successCount</strong> assignation(s) importée(s) avec succès.</p>";
            echo "</div>";
        }
        ...
        echo "<a href='assignStudents.php' class='btn btn-primary'><i class='fas fa-list me-2'></i>Voir les assignations</a> ";
        echo "<a href='importAssignments.php' class='btn btn-secondary'><i class='fas fa-redo me-2'></i>Nouvelle importation</a>";
        echo "</div></div></div>";
        ...
        echo "</div>";
        echo "<a href='importAssignments.php' class='btn btn-secondary'><i class='fas fa-arrow-left me-2'></i>Retour</a>";
        echo "</div></div></div>";
    }
    exit;
}

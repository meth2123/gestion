        ...
        <div class="col-12">
            <div class="alert alert-info d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <strong>Importation en masse</strong> - Téléversez un fichier Excel pour assigner plusieurs étudiants à la fois
                </div>
                <a href="importAssignments.php" class="btn btn-success">
...
// Ajout du script JS pour le bouton Sélectionner tout
$content .= '
<script>
document.addEventListener("DOMContentLoaded", function() {
    const selectAllBtn = document.getElementById("select-all-students-btn");
    if (selectAllBtn) {
        ...
        selectAllBtn.addEventListener("click", function() {
            ...
            selectAllBtn.textContent = allSelected ? "Tout désélectionner" : "Sélectionner tout";
        });
    }
});
</script>';

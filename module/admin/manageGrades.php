    ...
    <div class="container py-4">
        ...
        <div class="alert alert-info d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <strong>Importation en masse</strong> - Téléversez un fichier Excel pour saisir plusieurs notes à la fois
            </div>
            <a href="importGrades.php" class="btn btn-success">
                                        ...
                                        <tbody>
                                            <?php foreach ($check_grades as $grade): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo isset($grade['grade']) && $grade['grade'] !== null ? number_format((float)$grade['grade'], 2) . '/20' : '<span class="text-muted">Non noté</span>'; ?></td>

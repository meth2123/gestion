...
$stmt = $link->prepare("
    ...
    WHERE id = ? AND CONVERT(created_by USING utf8mb4) = CONVERT(? USING utf8mb4)
");
...
$stmt = $link->prepare("DELETE FROM class_schedule WHERE id = ? AND CONVERT(created_by USING utf8mb4) = CONVERT(? USING utf8mb4)");
$stmt->bind_param("is", $schedule_id, $admin_id);

        ...
        <div class="col-12">
            <div class="alert alert-info d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <strong>Importation en masse</strong> - Téléversez un fichier Excel pour ajouter plusieurs enseignants à la fois
                </div>
                <a href="importTeachers.php" class="btn btn-success">
        ...
        <div class="col-md-10 col-lg-8">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h4 class="card-title text-center mb-0">Ajouter un Enseignant</h4>
                </div>
                <div class="card-body">
                    <form action="addTeacher.php" method="post" onsubmit="return validateTeacherForm();">
                        <!-- Nom et Email -->
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender" id="genderMale" value="male" ' . (isset($_POST['gender']) && $_POST['gender'] == 'male' ? 'checked' : '') . '>
                                        <label class="form-check-label" for="genderMale">
                                            Masculin
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="gender" id="genderFemale" value="female" ' . (isset($_POST['gender']) && $_POST['gender'] == 'female' ? 'checked' : '') . '>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <textarea id="address" name="address" rows="3" placeholder="Entrer l\'adresse"
                                          class="form-control">' . htmlspecialchars($_POST['address'] ?? '') . '</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-between align-items-center">
                                ...
                                <button type="submit" name="submit" value="1" class="btn btn-primary">
                                    <i class="fas fa-user-plus me-2"></i>Ajouter l\'enseignant
                                </button>
                            </div>
                        </div>
                    </form>

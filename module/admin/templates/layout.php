...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?php echo $base_path; ?>new_timetable.php" class="<?php echo basename($_SERVER['PHP_SELF']) === 'new_timetable.php' || basename($_SERVER['PHP_SELF']) === 'new_create_timetable.php' || basename($_SERVER['PHP_SELF']) === 'new_edit_timetable.php' ? 'active' : ''; ?>">

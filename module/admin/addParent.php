            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Téléversez un fichier Excel pour ajouter plusieurs parents à la fois</p>
                    </div>
                </div>
                <a href="importParents.php" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition duration-200">
                    <i class="fas fa-upload mr-2"></i>Importer depuis Excel
                </a>
            </div>
        </div>
...
<?php
// Close database statements (ne pas fermer $conn car il est partagé)

...
<div class="mb-5">
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-6 col-md-3">
            <a href="./create_director_form.php" class="card h-100 border-0 shadow-sm text-decoration-none text-dark">
                <div class="card-body">
                    <h5 class="card-title">Nouveau directeur</h5>
                    <p class="card-text text-muted small">Créer un compte directeur</p>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="row g-3">
        <div class="col-6 col-md-3">
            <a href="./attendance.php" class="card h-100 border-0 shadow-sm text-decoration-none text-dark border-start border-5 border-danger">
                <div class="card-body">
                    <h5 class="card-title">historiques des presence</h5>
                    <p class="card-text text-muted small">Gérer l'historiques des presence</p>
                </div>
            </a>
        </div>
        <div class="col-6 col-md-3">
    ...
    <div class="row g-3">
        <div class="col-6 col-md-3">
            <a href="./attendStaff.php" class="card h-100 border-0 shadow-sm text-decoration-none text-dark border-start border-5 border-secondary">
                <div class="card-body">
                    <h5 class="card-title">Présence personnel</h5>
                    <p class="card-text text-muted small">Gérer présences personnel</p>
                </div>
            </a>
        </div>
    </div>
...
<div class="mb-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="./manageCoefficients.php" class="card border-0 shadow-sm text-decoration-none text-dark h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <i class="fas fa-balance-scale fs-1 text-success"></i>
                        </div>
                        <div class="ms-3">
                            <h5 class="card-title">Coefficients</h5>
                            <p class="card-text text-muted small">Gérer les coefficients des notes</p>
                        </div>
                    </div>
                </div>
            </a>

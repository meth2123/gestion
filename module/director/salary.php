    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <div class="d-flex gap-3">
                <a href="updateTeacherSalary.php" class="btn btn-primary">
                    <i class="fas fa-chalkboard-teacher me-2"></i>Mettre à jour les salaires des enseignants
                </a>
                <a href="updateStaffSalary.php" class="btn btn-success">
                    <i class="fas fa-user-tie me-2"></i>Mettre à jour les salaires du personnel
                </a>
            </div>
        </div>
    </div>
                        ...
                        if ($teacher_result->num_rows > 0) {
                            while ($row = $teacher_result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>' . number_format($row['salary'], 2) . ' FCFA</td>
                                    <td class="text-success">' . $row['present_days'] . '</td>
                                    <td class="text-danger">' . $row['absent_days'] . '</td>
                                    <td class="fw-bold text-primary">' . number_format($row['currentmonthlysalary'], 2) . ' FCFA</td>
                                    <td>';
                                    ...
                                    if ($row['payment_date']) {
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            $selected_date = strtotime($selected_year . '-' . $selected_month . '-01');

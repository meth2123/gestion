...
$params = [$_SESSION['student_id'], $student_info['classid']];
$types = 'ss';
...
$grades = db_fetch_all($grades_query, $params, $types);
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex flex-col md:flex-row justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 md:mb-0">Bulletin de notes</h2>
                
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    <!-- Filtres par semestre -->
                    <div class="flex items-center">
                        <span class="mr-2 text-gray-700">Semestre :</span>
                        <div class="flex space-x-2">
                            <?php
                            // Récupérer le semestre sélectionné depuis l'URL ou utiliser 0 (tous) par défaut
                            $selected_semester = isset($_GET['semester']) ? intval($_GET['semester']) : 0;
                            ?>
                            <a href="course.php" class="<?php echo $selected_semester === 0 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> px-3 py-1 rounded-md text-sm font-medium hover:bg-blue-500 hover:text-white transition-colors">
                                Tous
                            </a>
                            <a href="course.php?semester=1" class="<?php echo $selected_semester === 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> px-3 py-1 rounded-md text-sm font-medium hover:bg-blue-500 hover:text-white transition-colors">
                                Semestre 1
                            </a>
                            <a href="course.php?semester=2" class="<?php echo $selected_semester === 2 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> px-3 py-1 rounded-md text-sm font-medium hover:bg-blue-500 hover:text-white transition-colors">
                                Semestre 2
                            </a>
                            <a href="course.php?semester=3" class="<?php echo $selected_semester === 3 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'; ?> px-3 py-1 rounded-md text-sm font-medium hover:bg-blue-500 hover:text-white transition-colors">
                                Semestre 3
                            </a>
                        </div>
                    </div>

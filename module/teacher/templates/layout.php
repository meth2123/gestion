<?php
// Sécurise la récupération de l'id enseignant depuis la session
            ...
            <div class="col-lg-3 mb-4">
                <div class="sidebar bg-white shadow-sm rounded p-3">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="documents.php" class="list-group-item list-group-item-action <?php echo basename($_SERVER['PHP_SELF']) === 'documents.php' ? 'active' : ''; ?>">
